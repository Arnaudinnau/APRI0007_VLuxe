...
## Project Report
The [project report](https://github.com/Arnaudinnau/APRI0007_VLuxe/blob/main/Report_V_Luxe.pdf) outlines the whole project components including management, electronics, mechanics, software and control system. Technicals choices that have been done during the whole project elaboration are justified. Some improvement paths are also developed at the end of this report.
